...
class StudentController extends Controller
{
    ...
    function RegisterStudent(Request $req){
        ...
        $UserRole = $this->audit->RoleAuthenticator($req->SenderId, "RegisterStudent");
    ...
    public function BulkRegisterStudent(Request $req)
    {
        ...
        $UserRole = $this->audit->RoleAuthenticator($req->SenderId, "BulkRegisterStudent");
        if ($UserRole !== null && $UserRole->getStatusCode() !== 200) {
            return $UserRole;
        }
    ...
    public function BulkAutoGeneratedRegisterStudent(Request $req)
    {
        ...
        $UserRole = $this->audit->RoleAuthenticator($req->SenderId, "BulkAutoGeneratedRegisterStudent");
        if ($UserRole !== null && $UserRole->getStatusCode() !== 200) {
            return $UserRole;
        }
    ...
    function UpdateStudent(Request $req){
        ...
        $UserRole = $this->audit->RoleAuthenticator($req->SenderId, "UpdateStudent");
        if ($UserRole !== null && $UserRole->getStatusCode() !== 200) {
            return $UserRole;
        }
    ...
    public function GetStudentInAClass(Request $req)
    {
        ...
        $UserRole = $this->audit->RoleAuthenticator($req->SenderId, "ViewStudentInClass");
        if ($UserRole !== null && $UserRole->getStatusCode() !== 200) {
            return $UserRole;
        }
    ...
    public function GetStudentInASchool(Request $req)
    {
        ...
        $UserRole = $this->audit->RoleAuthenticator($req->SenderId, "ViewStudentInSchool");
        if ($UserRole !== null && $UserRole->getStatusCode() !== 200) {
            return $UserRole;
        }
    ...
    public function GetStudentInAClassFile(Request $req)
    {
        ...
        $UserRole = $this->audit->RoleAuthenticator($req->SenderId, "GenerateStudentInClass");
        if ($UserRole !== null && $UserRole->getStatusCode() !== 200) {
            return $UserRole;
        }
    ...
    public function GetStudentInSchoolFile(Request $req)
    {
        ...
        $UserRole = $this->audit->RoleAuthenticator($req->SenderId, "GenerateStudentInSchool");
        if ($UserRole !== null && $UserRole->getStatusCode() !== 200) {
            return $UserRole;
        }
