...
Route::get("ViewStaffMembers/{StaffId}/{CompanyId}/{SenderId}",[StaffMembersController::class,"ViewStaffMembers"]);
Route::post("DeleteStaffMembers/{StaffId}/{CompanyId}/{SenderId}",[StaffMembersController::class,"DeleteStaffMembers"]);
